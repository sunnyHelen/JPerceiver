...
data = dict(
    ...
    width = WIDTH,
    frame_ids = FRAME_IDS,
    in_path = '/public/data1/users/zhaohaimei3/kitti_data/odometry/dataset/sequences',#path to raw data
...
resume_from=None#'/public/data1/users/zhaohaimei3/DepthLayout_kitti_odometry_loss_transformer/log/depthLayoutKittiOdomwithscale/epoch_19.pth'
finetune = None
total_epochs = 80
imgs_per_gpu = IMGS_PER_GPU
learning_rate = 1e-4
