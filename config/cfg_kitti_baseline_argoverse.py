...
data = dict(
    ...
    width = WIDTH,
    frame_ids = FRAME_IDS,
    in_path = '/public/data1/users/zhaohaimei3/kitti_data/argoverse/',#path to raw data
    gt_depth_path = None,#'/public/data1/users/zhaohaimei3/FeatDepth-master/mono/datasets/splits/test/gt_depths.npz',#path to gt data
