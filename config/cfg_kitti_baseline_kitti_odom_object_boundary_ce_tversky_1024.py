...
resume_from='/CV/zhaohaimei3/DepthLayout_kitti_odometry_loss_transformerright_object_focalloss_1024/log/object_boundaryloss_mul20_tversky_mul20_ce/latest.pth'
finetune = None
total_epochs = 180
imgs_per_gpu = IMGS_PER_GPU
learning_rate = 1e-4
