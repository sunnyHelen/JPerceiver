...
IMGS_PER_GPU = 10 #the number of images fed to each GPU
...
resume_from=None#'/CV/zhaohaimei3/DepthLayout_kitti_odometry_loss_transformerright_object_argoverse_A100-512/log/argostatic4GPUB12/latest.pth'
finetune = None
total_epochs = 120
imgs_per_gpu = IMGS_PER_GPU
learning_rate = 3e-4
