...
IMGS_PER_GPU = 6 #the number of images fed to each GPU
HEIGHT = 512#192#input image height
WIDTH = 512#640#input image width
...
resume_from=None##'/CV/zhaohaimei3/DepthLayout_kitti_odometry_loss_transformerright_object_argoverse_A100-512/log/argostatic1GPUB12/epoch_10.pth'
finetune = None
total_epochs = 120
imgs_per_gpu = IMGS_PER_GPU
learning_rate = 1e-4
